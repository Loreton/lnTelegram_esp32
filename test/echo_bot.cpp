...
const char* ssid  =  casetta_ssid;     // SSID WiFi network
const char* pass  =  casetta_password;     // Password  WiFi network
const char* token =  lnChannelUserBot_token;  // Telegram token

// Target user can find it's own userid with the bot @JsonDumpBot
// https://t.me/JsonDumpBot
int64_t userid = nLoreto_ChatID;


// Name of public channel (your bot must be in admin group)
const char* channel = lnChannelUserBot_name;
